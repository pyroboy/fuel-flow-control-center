...
import { Order, OrderItem, OrderStatus, OrderType, PaymentMethod, PaymentStatus, UserRole } from '@/types';
...
const initialMockOrderItems: OrderItem[] = [
  ...
  { id: 'oi_1', order_id: 'ord_1', fuel_type_id: 'ft_1', quantity_liters: 5000, price_per_liter_at_order: 68.00 }, // Current Diesel price

  // Items for Order 2 (ord_2)
  { id: 'oi_2', order_id: 'ord_2', fuel_type_id: 'ft_2', quantity_liters: 3000, price_per_liter_at_order: 71.25 }, // Current Gas 95 price

  // Items for Order 3 (ord_3)
  { id: 'oi_3', order_id: 'ord_3', fuel_type_id: 'ft_4', quantity_liters: 8000, price_per_liter_at_order: 78.50 }, // Current Premium 97 price

  // Items for Order 4 (ord_4)
  { id: 'oi_4', order_id: 'ord_4', fuel_type_id: 'ft_1', quantity_liters: 10000, price_per_liter_at_order: 68.00 }, // Diesel price at time of order

  // Items for Order 5 (ord_5) - Multiple items
  { id: 'oi_5', order_id: 'ord_5', fuel_type_id: 'ft_1', quantity_liters: 4000, price_per_liter_at_order: 68.00 }, // Diesel price at time of order
  { id: 'oi_6', order_id: 'ord_5', fuel_type_id: 'ft_2', quantity_liters: 2000, price_per_liter_at_order: 71.25 }, // Gas 95 price at time of order

  // Items for Order 6 (ord_6)
  { id: 'oi_7', order_id: 'ord_6', fuel_type_id: 'ft_4', quantity_liters: 1500, price_per_liter_at_order: 78.50 }, // Premium 97 price

  // Items for Order 7 (ord_7)
  { id: 'oi_8', order_id: 'ord_7', fuel_type_id: 'ft_1', quantity_liters: 2500, price_per_liter_at_order: 68.00 }, // Diesel price at time of order

  // Items for Order 8 (ord_8)
  { id: 'oi_9', order_id: 'ord_8', fuel_type_id: 'ft_2', quantity_liters: 5000, price_per_liter_at_order: 71.25 }, // Gas 95 price at time of order
];
...
const Orders: React.FC = () => {
  ...
  const [orderItems, setOrderItems] = useState<OrderItem[]>(initialMockOrderItems);
  ...
  const totalOrderValue = useMemo(() => {
    return orderItems.reduce((sum, item) => sum + (item.quantity_liters * item.price_per_liter_at_order), 0);
  }, [orderItems]);
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        ...
        <Button className="bg-indigo-900 hover:bg-indigo-800" onClick={handleNewOrder}>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Order Dashboard</CardTitle>
           <CardDescription>
             Displaying {orders.length} mock orders. (Table implementation pending)
           </CardDescription>
        </CardHeader>
        <CardContent>
          {/* TODO: Replace this paragraph with an actual Table component */}
          {/* Use the 'orders' and 'orderItems' state along with the helper maps */}
          {/* Example: You would map over 'orders' to create TableRows */}
          <div className="text-center text-gray-500 py-12 border border-dashed rounded-md">
            <p className="font-semibold mb-2">Order Table Placeholder</p>
            <p className="text-sm">
              Implement a TanStack Table (or similar) here to display the order data.
            </p>
            <p className="text-sm mt-1">
              Use `mockUserMap`, `mockGasStationMap`, `mockFuelTypeMap` to show names instead of IDs.
            </p>
            <p className="text-sm mt-1">
              Data includes various statuses: Pending, Confirmed, Scheduled, OutForDelivery, Delivered, ReadyForPickup, PickedUp, Cancelled.
            </p>
          </div>
        </CardContent>
      </Card>
